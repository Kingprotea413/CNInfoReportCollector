...
# Final bank-template overrides use CNInfo's bank-specific 2007 statement APIs
# (p_stock2325 / p_stock2326 / p_stock2327) instead of the generic company fields.
BANK_BALANCE_RESOLVERS.update(
    {
        canonical_label("现金"): field("F007N"),
        canonical_label("贵金属"): field("F012N"),
        canonical_label("存放同业和其他金融机构款项"): field("F006N"),
        canonical_label("存放同业及其他金融机构款项"): field("F006N"),
        canonical_label("拆出资金"): field("F013N"),
        canonical_label("买入返售金融资产"): field("F016N"),
        canonical_label("贷款和垫款"): field("F027N"),
        canonical_label("发放贷款及垫款"): field("F027N"),
        canonical_label("衍生金融资产"): field("F015N"),
        canonical_label("以公允价值计量且其变动计入当期损益的金融投资"): first_available(field("F014N"), field("F117N")),
        canonical_label("以摊余成本计量的债务工具投资"): first_available(field("F110N"), field("F033N")),
        canonical_label("以公允价值计量且其变动计入其他综合收益的债务工具投资"): first_available(
            field("F111N"), field("F032N")
        ),
        canonical_label("指定为以公允价值计量且其变动计入其他综合收益的权益工具投资"): field("F112N"),
        canonical_label("长期股权投资"): field("F034N"),
        canonical_label("投资性房地产"): field("F036N"),
        canonical_label("固定资产"): field("F038N"),
        canonical_label("在建工程"): field("F039N"),
        canonical_label("使用权资产"): field("F115N"),
        canonical_label("无形资产"): field("F040N"),
        canonical_label("商誉"): field("F101N"),
        canonical_label("递延所得税资产"): field("F045N"),
        canonical_label("其他资产"): field("F046N"),
        canonical_label("资产合计"): field("F047N"),
        canonical_label("向中央银行借款"): field("F048N"),
        canonical_label("同业和其他金融机构存放款项"): field("F049N"),
        canonical_label("同业及其他金融机构存放款项"): field("F049N"),
        canonical_label("同业存放及其他金融机构存放款项"): field("F049N"),
        canonical_label("拆入资金"): field("F052N"),
        canonical_label("以公允价值计量且其变动计入当期损益的金融负债"): first_available(field("F053N"), field("F113N")),
        canonical_label("衍生金融负债"): field("F054N"),
        canonical_label("卖出回购金融资产款"): field("F055N"),
        canonical_label("客户存款"): field("F056N"),
        canonical_label("吸收存款"): field("F056N"),
        canonical_label("应付职工薪酬"): field("F066N"),
        canonical_label("应交税费"): field("F065N"),
        canonical_label("应付利息"): field("F067N"),
        canonical_label("合同负债"): field("F113N"),
        canonical_label("租赁负债"): field("F116N"),
        canonical_label("预计负债"): field("F069N"),
        canonical_label("应付债券"): field("F078N"),
        canonical_label("递延所得税负债"): field("F080N"),
        canonical_label("其他负债"): field("F081N"),
        canonical_label("负债合计"): field("F082N"),
        canonical_label("股本"): field("F083N"),
        canonical_label("实收资本（或股本）"): field("F083N"),
        canonical_label("其他权益工具"): field("F097N"),
        canonical_label("优先股"): field("F098N"),
        canonical_label("其中：优先股"): field("F098N"),
        canonical_label("永续债"): field("F099N"),
        canonical_label("资本公积"): field("F084N"),
        canonical_label("其他综合收益"): field("F100N"),
        canonical_label("盈余公积"): field("F086N"),
        canonical_label("一般风险准备"): field("F087N"),
        canonical_label("未分配利润"): field("F088N"),
        canonical_label("归属于本行股东权益合计"): field("F094N"),
        canonical_label("少数股东权益"): field("F089N"),
        canonical_label("股东权益合计"): field("F092N"),
        canonical_label("负债及股东权益总计"): field("F093N"),
    }
)
...
BANK_INCOME_RESOLVERS.update(
    {
        canonical_label("营业收入"): field("F006N"),
        canonical_label("利息净收入"): field("F007N"),
        canonical_label("利息收入"): first_available(field("F075N"), field("F008N")),
        canonical_label("利息支出"): first_available(field("F084N"), field("F009N")),
        canonical_label("净利息收入"): field("F007N"),
        canonical_label("手续费及佣金净收入"): field("F010N"),
        canonical_label("手续费及佣金收入"): first_available(field("F076N"), field("F011N")),
        canonical_label("手续费及佣金支出"): field("F012N"),
        canonical_label("净手续费及佣金收入"): field("F010N"),
        canonical_label("投资收益"): field("F021N"),
        canonical_label("其中：对合营企业及联营企业的投资收益"): field("F022N"),
        canonical_label("以摊余成本计量的金融资产终止确认产生的收益"): field("F077N"),
        canonical_label("公允价值变动收益"): field("F023N"),
        canonical_label("汇兑净收益"): field("F024N"),
        canonical_label("汇兑收益"): field("F024N"),
        canonical_label("其他业务收入"): field("F025N"),
        canonical_label("其他净收入"): first_available(field("F062N"), field("F078N")),
        canonical_label("营业收入小计"): field("F006N"),
        canonical_label("税金及附加"): field("F034N"),
        canonical_label("业务及管理费"): field("F036N"),
        canonical_label("信用减值损失"): field("F066N"),
        canonical_label("其他资产减值损失"): field("F038N"),
        canonical_label("其他业务成本"): field("F039N"),
        canonical_label("营业支出合计"): field("F026N"),
        canonical_label("营业利润"): field("F040N"),
        canonical_label("加：营业外收入"): field("F042N"),
        canonical_label("减：营业外支出"): field("F043N"),
        canonical_label("利润总额"): field("F045N"),
        canonical_label("减：所得税费用"): field("F046N"),
        canonical_label("净利润"): field("F048N"),
        canonical_label("本行股东的净利润"): field("F049N"),
        canonical_label("少数股东的净利润"): field("F050N"),
        canonical_label("基本及稀释每股收益"): first_available(field("F052N"), field("F053N")),
        canonical_label("本年综合收益总额"): field("F054N"),
        canonical_label("本行股东的综合收益总额"): field("F055N"),
        canonical_label("少数股东的综合收益总额"): field("F056N"),
    }
)

BANK_CASH_RESOLVERS.update(
    {
        canonical_label("存放中央银行款项净减少额"): field("F067N"),
        canonical_label("交易目的而持有的金融资产净减少额"): field("F011N"),
        canonical_label("存放同业和其他金融机构款项净减少额"): official_value("存放同业和其他金融机构款项净减少额"),
        canonical_label("拆入资金及卖出回购金融资产款净增加额"): official_value("拆入资金及卖出回购金融资产款净增加额"),
        canonical_label("同业和其他金融机构存放款项净增加额"): official_value("同业和其他金融机构存放款项净增加额"),
        canonical_label("客户存款净增加额"): official_value("客户存款净增加额"),
        canonical_label("收取的利息、手续费及佣金的现金"): field("F010N"),
        canonical_label("收取利息、手续费及佣金的现金"): field("F010N"),
        canonical_label("收到其他与经营活动有关的现金"): field("F019N"),
        canonical_label("经营活动现金流入小计"): field("F020N"),
        canonical_label("存放同业和其他金融机构款项净增加额"): official_value("存放同业和其他金融机构款项净增加额"),
        canonical_label("拆出资金及买入返售金融资产净增加额"): official_value("拆出资金及买入返售金融资产净增加额"),
        canonical_label("贷款和垫款净增加额"): field("F021N"),
        canonical_label("为交易目的而持有的金融资产净增加额"): field("F064N"),
        canonical_label("向中央银行借款净减少额"): field("F060N"),
        canonical_label("拆入资金及卖出回购金融资产款净减少额"): official_value("拆入资金及卖出回购金融资产款净减少额"),
        canonical_label("支付的利息、手续费及佣金的现金"): field("F023N"),
        canonical_label("支付利息、手续费及佣金的现金"): field("F023N"),
        canonical_label("支付给职工以及为职工支付的现金"): field("F027N"),
        canonical_label("支付的各项税费"): field("F028N"),
        canonical_label("支付其他与经营活动有关的现金"): field("F029N"),
        canonical_label("经营活动现金流出小计"): field("F030N"),
        canonical_label("经营活动产生的现金流量净额"): field("F031N"),
        canonical_label("收回投资收到的现金"): field("F033N"),
        canonical_label("取得投资收益收到的现金"): field("F034N"),
        canonical_label("处置子公司、合营企业或联营企业收到的现金"): official_value("处置子公司、合营企业或联营企业收到的现金"),
        canonical_label("出售固定资产和其他资产收到的现金"): field("F068N"),
        canonical_label("投资活动现金流入小计"): field("F036N"),
        canonical_label("投资支付的现金"): field("F037N"),
        canonical_label("取得子公司、合营企业或联营企业支付的现金"): official_value("取得子公司、合营企业或联营企业支付的现金"),
        canonical_label("购建固定资产和其他资产所支付的现金"): field("F039N"),
        canonical_label("投资活动现金流出小计"): field("F041N"),
        canonical_label("投资活动产生的现金流量净额"): field("F042N"),
        canonical_label("发行存款证及其他收到的现金"): official_value("发行存款证及其他收到的现金"),
        canonical_label("发行同业存单收到的现金"): official_value("发行同业存单收到的现金"),
        canonical_label("发行债券收到的现金"): field("F045N"),
        canonical_label("发行永续债募集的资金"): official_value("发行永续债募集的资金"),
        canonical_label("收到其他与筹资活动有关的现金"): field("F047N"),
        canonical_label("筹资活动现金流入小计"): field("F048N"),
        canonical_label("偿还存款证及其他支付的现金"): official_value("偿还存款证及其他支付的现金"),
        canonical_label("偿还同业存单支付的现金"): official_value("偿还同业存单支付的现金"),
        canonical_label("偿还债券支付的现金"): official_value("偿还债券支付的现金"),
        canonical_label("赎回永续债支付的现金"): official_value("赎回永续债支付的现金"),
        canonical_label("支付租赁负债的现金"): official_value("支付租赁负债的现金"),
        canonical_label("赎回永续债务资本利息支付的现金"): official_value("赎回永续债务资本利息支付的现金"),
        canonical_label("派发普通股股利支付的现金"): official_value("派发普通股股利支付的现金"),
        ...
        canonical_label("派发永续债利息支付的现金"): official_value("派发永续债利息支付的现金"),
        canonical_label("支付筹资活动的利息"): official_value("支付筹资活动的利息"),
        canonical_label("支付其他与筹资活动有关的现金"): field("F051N"),
        canonical_label("筹资活动现金流出小计"): field("F052N"),
        canonical_label("筹资活动产生的现金流量净额"): field("F053N"),
        canonical_label("四、汇率变动对现金及现金等价物的影响额"): field("F054N"),
        canonical_label("五、现金及现金等价物净（减少）/增加额"): field("F056N"),
        canonical_label("加：年初现金及现金等价物余额"): field("F057N"),
        canonical_label("六、年末现金及现金等价物余额"): field("F058N"),
    }
)
